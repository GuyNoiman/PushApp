...
| O-29 | **The engine still asks everything on its list** | Gap, next slice | The composer is told what is known and told not to ask it again, but the question is still SHOWN with its cards, so it gets asked. Skipping needs the resolve-from-natural-language step (spec §4.4) — that is what closes findings 6, 7, 10 and 12 together |
