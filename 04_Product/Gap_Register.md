...
| **Account restore on a new device** | **BROKEN — found 2026-09-17** | The backup check runs once per app life and is spent on the anonymous launch session; the backup gateway caches that anonymous user id; and backups need a `profiles` row nothing creates. So a person who signs in on a new phone gets nothing back, and new accounts may never have been backed up at all. Plan Stage 0: `04_Product/Dev_Accounts_And_Restore_Plan_2026-09-17.md`. |
