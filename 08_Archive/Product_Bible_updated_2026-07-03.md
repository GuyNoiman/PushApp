...
The users may each have their own Quest, but the competition requires a comparable time frame and comparable progress model.
...
- Same Quest template, same duration
- Different Quests, same time frame, compared by completion percentage
...
- Users choosing easier Quests to win
...
# 33. Intervention Engine

Status: Approved Product Direction

PushApp does not optimize notifications. It optimizes interventions.
